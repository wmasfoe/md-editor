  ...
  resolve: {
    alias: {
      ...
      "@md-editor/markdown-fidelity": fileURLToPath(
        new URL(
          "../../packages/markdown-fidelity/src/index.ts",
          import.meta.url,
        ),
      ),
      "@md-editor/mdx-component-registry": fileURLToPath(
        new URL(
          "../../packages/mdx-component-registry/src/index.ts",
          import.meta.url,
        ),
      ),
      ...
      "@milkdown/kit/plugin/history": fileURLToPath(
        new URL(
          "../../node_modules/@milkdown/kit/lib/plugin/history.js",
          import.meta.url,
        ),
      ),
      ...
      "@milkdown/kit/preset/gfm": fileURLToPath(
        new URL(
          "../../node_modules/@milkdown/kit/lib/preset/gfm.js",
          import.meta.url,
        ),
      ),
