...
- 新增繁体中文（zh-Hant）与日文（ja）多语言完整支持与下拉选择器，根据浏览器/系统语言偏好智能匹配
- 示例展示文档（Showcase）提供四种语言版本，支持实时多语言热切换与代码预览
- 全面多语言化侧边栏、文件树面板、右键上下文菜单及偏好设置弹窗
- 编辑器内核新增行内 AI 幽灵补全提示（Tab 接受 · Esc 取消）多语言热更新响应
