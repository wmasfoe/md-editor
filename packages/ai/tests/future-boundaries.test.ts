...
describe("future AI boundaries", () => {
  ...
  it("defines connector and agent descriptors without a runtime", async () => {
    ...
    await expect(Promise.resolve(connector.getSnapshot())).resolves.toMatchObject({ before: "Hello" });
