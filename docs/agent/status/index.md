...
用途：记录阶段实现状态、尖刺结论和已完成打磨项。需要判断“当前做到哪里、还有哪些缺口、历史验证情况如何”时读本目录。

## 文档

- CM6 单编辑器迁移实时状态（S1/M0 beta、M1/S2 与 M1-FM/S5-FM-only 已验证、证据边界及 M2-M6 缺口）： [codemirror_renderer_migration_status.md](./codemirror_renderer_migration_status.md)
...
- 已完成的状态及时标注已完成，确保代码和文档状态保持一致。
- Beta 可用与完整迁移完成必须分开记录；没有代码和验证证据时不得提前更新状态。
