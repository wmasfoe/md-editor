...
- CodeMirror 6 Markdown 可视化编辑器架构方案（权威目标；S1/M0 beta，M1/S2 与 M1-FM/S5-FM-only 已验证，M2-M6 仍未完成）： [custom_markdown_renderer_architecture.md](./custom_markdown_renderer_architecture.md)
