...
>
> 状态：**产品行为已确认；G001-G007 已完成基线、核心协议、保存排序/原生授权、CM6 renderer、React bridge、desktop main 接入和旧运行时清理。产品代码、依赖、Vite alias 与生产 bundle 现在只保留一个持久 `DesktopCodeMirrorEditor`；G008 全仓自动化、changed-file cleaner、初轮独立复核修复、post-fix 全量重验、非交互 Tauri 启动冒烟及清洁独立复核已通过，2026-07-18 原生系统 IME、Save/Save As、settings、asset preview 与 LF 人工验收也已通过。因此 S1/M0 当前为 CM6-only beta 可用，但不代表 S2-S6、M1-M5 或完整可视化迁移已经完成。**
>
