...
export const zh: TranslationSchema = {
  ...
  changelog: {
    ...
    tabsAria: "选择更新记录类型",
    clientTab: "桌面客户端",
    androidTab: "Android 移动端",
    webTab: "Web 在线版",
    modelTab: "模型更新",
    descriptionPrefix: "桌面客户端版本的变更说明。内容来自仓库",
    descriptionSuffix: "。",
    androidDescriptionPrefix: "Android 原生移动端版本的变更说明。内容来自仓库",
    webDescriptionPrefix: "Web 在线体验版的版本变更说明。内容来自仓库",
    modelDescriptionPrefix: "本地 AI 模型的版本变更，内容从模型仓库的",
    modelDescriptionSuffix: "自动同步。",
    modelOriginalLanguage: "",
    empty: "暂无客户端更新记录。",
    androidEmpty: "暂无 Android 移动端更新记录。",
    webEmpty: "暂无 Web 端更新记录。",
    modelEmpty: "暂无模型更新记录。",
    listAria: "更新记录列表",
